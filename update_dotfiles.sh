...
rsync -a --mkpath --delete-after "${HOME}/.config/aider/" "${DIR}/dotfiles/.config/aider/"
...
rsync -a --mkpath --delete-after "${HOME}/.config/htop/" "${DIR}/dotfiles/.config/htop/"
rsync -a --mkpath "${HOME}/.config/i3/config" "${DIR}/dotfiles/.config/i3/config"
rsync -a --mkpath --exclude logs.db --exclude keys.json "${HOME}/.config/io.datasette.llm/" "${DIR}/dotfiles/.config/io.datasette.llm/"
...
rsync -a --mkpath --delete-after "${HOME}/.config/nvim/lua/" "${DIR}/dotfiles/.config/nvim/lua/"
rsync -a --mkpath --delete-after "${HOME}/.config/ranger/" "${DIR}/dotfiles/.config/ranger/"
rsync -a --mkpath --delete-after "${HOME}/.config/rofi/" "${DIR}/dotfiles/.config/rofi/"
...
rsync -a --mkpath --delete-after "${HOME}/.config/waybar/" "${DIR}/dotfiles/.config/waybar/"
rsync -a --mkpath --delete-after "${HOME}/.config/tmux/" "${DIR}/dotfiles/.config/tmux/"
rsync -a --mkpath --delete-after "${HOME}/.config/uv/" "${DIR}/dotfiles/.config/uv/"
rsync -a --mkpath --delete-after "${HOME}/.config/pnpm/" "${DIR}/dotfiles/.config/pnpm/"
rsync -a --mkpath "${HOME}/.npmrc" "${DIR}/dotfiles/.npmrc"
rsync -a --mkpath "${HOME}/.bunfig.toml" "${DIR}/dotfiles/.bunfig.toml"
